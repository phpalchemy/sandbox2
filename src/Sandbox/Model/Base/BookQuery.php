...
use Sandbox\Model\Map\BookTableMap;
...
abstract class BookQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Sandbox\Model\Base\BookQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'Sandbox', $modelName = '\\Sandbox\\Model\\Book', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Sandbox\Model\BookQuery) {
            return $criteria;
        }
        $query = new \Sandbox\Model\BookQuery();
        if (null !== $modelAlias) {
    ...
    /**
     * Filter the query by a related \Sandbox\Model\Publisher object
     *
     * @param \Sandbox\Model\Publisher|ObjectCollection $publisher The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildBookQuery The current query, for fluid interface
     */
    ...
    {
        if ($publisher instanceof \Sandbox\Model\Publisher) {
            return $this
            ...
            throw new PropelException('filterByPublisher() only accepts arguments of type \Sandbox\Model\Publisher or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Sandbox\Model\PublisherQuery A secondary query class using the current class as primary query
     */
    public function usePublisherQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPublisher($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Publisher', '\Sandbox\Model\PublisherQuery');
    }

    /**
     * Filter the query by a related \Sandbox\Model\Author object
     *
     * @param \Sandbox\Model\Author|ObjectCollection $author The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildBookQuery The current query, for fluid interface
     */
    ...
    {
        if ($author instanceof \Sandbox\Model\Author) {
            return $this
            ...
            throw new PropelException('filterByAuthor() only accepts arguments of type \Sandbox\Model\Author or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Sandbox\Model\AuthorQuery A secondary query class using the current class as primary query
     */
    public function useAuthorQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinAuthor($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Author', '\Sandbox\Model\AuthorQuery');
    }
