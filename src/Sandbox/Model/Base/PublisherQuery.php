...
use Sandbox\Model\Publisher as ChildPublisher;
use Sandbox\Model\PublisherQuery as ChildPublisherQuery;
use Sandbox\Model\Map\PublisherTableMap;
 ...
 *
 * @method     array findById(int $id) Return ChildPublisher objects filtered by the id column
...
abstract class PublisherQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Sandbox\Model\Base\PublisherQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'sandbox', $modelName = '\\Sandbox\\Model\\Publisher', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Sandbox\Model\PublisherQuery) {
            return $criteria;
        }
        $query = new \Sandbox\Model\PublisherQuery();
        if (null !== $modelAlias) {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(PublisherTableMap::ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(PublisherTableMap::ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(PublisherTableMap::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(PublisherTableMap::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PublisherTableMap::ID, $id, $comparison);
    }
    ...
    /**
     * Filter the query by a related \Sandbox\Model\Book object
     *
     * @param \Sandbox\Model\Book|ObjectCollection $book  the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPublisherQuery The current query, for fluid interface
     */
    ...
    {
        if ($book instanceof \Sandbox\Model\Book) {
            return $this
                ->addUsingAlias(PublisherTableMap::ID, $book->getPublisherId(), $comparison);
            ...
            throw new PropelException('filterByBook() only accepts arguments of type \Sandbox\Model\Book or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Sandbox\Model\BookQuery A secondary query class using the current class as primary query
     */
    public function useBookQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinBook($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Book', '\Sandbox\Model\BookQuery');
    }
    ...
    {
        if ($publisher) {
            $this->addUsingAlias(PublisherTableMap::ID, $publisher->getId(), Criteria::NOT_EQUAL);
        }
