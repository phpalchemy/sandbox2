...
abstract class UserRol implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Sandbox\\Model\\Map\\UserRolTableMap';
    ...
    /**
     * Initializes internal state of Sandbox\Model\Base\UserRol object.
     */
     ...
     *
     * @return UserRol The current object, for fluid interface
     */
     ...
     * @return   \Sandbox\Model\UserRol The current object (for fluent API support)
     */
    public function setUsrId($v)
    {
        ...
        if ($this->usr_id !== $v) {
            $this->usr_id = $v;
            $this->modifiedColumns[] = UserRolTableMap::USR_ID;
        }
    ...
    public function setRolId($v)
    {
        ...
        if ($this->rol_id !== $v) {
            $this->rol_id = $v;
            $this->modifiedColumns[] = UserRolTableMap::ROL_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \Sandbox\Model\UserRol object", 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserRolTableMap::USR_ID)) {
            $modifiedColumns[':p' . $index++]  = 'USR_ID';
        }
        if ($this->isColumnModified(UserRolTableMap::ROL_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserRolTableMap::USR_ID)) $criteria->add(UserRolTableMap::USR_ID, $this->usr_id);
        if ($this->isColumnModified(UserRolTableMap::ROL_ID)) $criteria->add(UserRolTableMap::ROL_ID, $this->rol_id);
    ...
    {
        $criteria = new Criteria(UserRolTableMap::DATABASE_NAME);
        $criteria->add(UserRolTableMap::USR_ID, $this->usr_id);
        $criteria->add(UserRolTableMap::ROL_ID, $this->rol_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Sandbox\Model\UserRol (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Sandbox\Model\UserRol Clone of current object.
     * @throws PropelException
     */
