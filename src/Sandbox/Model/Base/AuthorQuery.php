...
abstract class AuthorQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Sandbox\Model\Base\AuthorQuery object.
     *
    ...
    {
        if ($criteria instanceof \Sandbox\Model\AuthorQuery) {
            return $criteria;
        }
        $query = new \Sandbox\Model\AuthorQuery();
        if (null !== $modelAlias) {
