...
use Sandbox\Model\Book as ChildBook;
use Sandbox\Model\BookQuery as ChildBookQuery;
...
abstract class Publisher implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Sandbox\\Model\\Map\\PublisherTableMap';
    ...
    /**
     * Initializes internal state of Sandbox\Model\Base\Publisher object.
     */
     ...
     *
     * @return Publisher The current object, for fluid interface
     */
     ...
     * @return   \Sandbox\Model\Publisher The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PublisherTableMap::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = PublisherTableMap::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \Sandbox\Model\Publisher object", 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->booksScheduledForDeletion !== null) {
                if (!$this->booksScheduledForDeletion->isEmpty()) {
                    \Sandbox\Model\BookQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[] = PublisherTableMap::ID;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . PublisherTableMap::ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(PublisherTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(PublisherTableMap::NAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PublisherTableMap::ID)) $criteria->add(PublisherTableMap::ID, $this->id);
        if ($this->isColumnModified(PublisherTableMap::NAME)) $criteria->add(PublisherTableMap::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(PublisherTableMap::DATABASE_NAME);
        $criteria->add(PublisherTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Sandbox\Model\Publisher (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Sandbox\Model\Publisher Clone of current object.
     * @throws PropelException
     */
    ...
    public function initBooks($overrideExisting = true)
    {
        ...
        $this->collBooks->setModel('\Sandbox\Model\Book');
    }
     ...
     * @return Collection|ChildBook[] List of ChildBook objects
     */
    public function getBooksJoinAuthor($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildBookQuery::create(null, $criteria);
