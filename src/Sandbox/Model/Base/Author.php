...
use Sandbox\Model\Author as ChildAuthor;
use Sandbox\Model\AuthorQuery as ChildAuthorQuery;
use Sandbox\Model\Book as ChildBook;
use Sandbox\Model\BookQuery as ChildBookQuery;
use Sandbox\Model\Map\AuthorTableMap;
...
abstract class Author implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Sandbox\\Model\\Map\\AuthorTableMap';
    ...
    /**
     * Initializes internal state of Sandbox\Model\Base\Author object.
     */
     ...
     * @return   \Sandbox\Model\Author The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \Sandbox\Model\Author object", 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Sandbox\Model\Author (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Sandbox\Model\Author Clone of current object.
     * @throws PropelException
     */
     ...
     * @return Collection|ChildBook[] List of ChildBook objects
     */
    public function getBooksJoinPublisher($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildBookQuery::create(null, $criteria);
