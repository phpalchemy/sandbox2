...
abstract class Book implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Sandbox\\Model\\Map\\BookTableMap';
    ...
    /**
     * Initializes internal state of Sandbox\Model\Base\Book object.
     */
     ...
     * @return   \Sandbox\Model\Book The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \Sandbox\Model\Book object", 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Sandbox\Model\Book (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Sandbox\Model\Book Clone of current object.
     * @throws PropelException
     */
