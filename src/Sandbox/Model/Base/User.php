...
abstract class User implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Sandbox\\Model\\Map\\UserTableMap';
    ...
    /**
     * Initializes internal state of Sandbox\Model\Base\User object.
     * @see applyDefaults()
     */
     ...
     * @return   \Sandbox\Model\User The current object (for fluent API support)
     */
    public function setUsrId($v)
    {
        ...
        if ($this->usr_id !== $v) {
            $this->usr_id = $v;
            $this->modifiedColumns[] = UserTableMap::USR_ID;
        }
    ...
    public function setUsrFirstName($v)
    {
        ...
        if ($this->usr_first_name !== $v) {
            ...
            $this->modifiedColumns[] = UserTableMap::USR_FIRST_NAME;
        }
    ...
    public function setUsrLastName($v)
    {
        ...
        if ($this->usr_last_name !== $v) {
            ...
            $this->modifiedColumns[] = UserTableMap::USR_LAST_NAME;
        }
    ...
    public function setUsrCreateDate($v)
    {
        ...
        if ($this->usr_create_date !== null || $dt !== null) {
            if ($dt !== $this->usr_create_date) {
                ...
                $this->modifiedColumns[] = UserTableMap::USR_CREATE_DATE;
            }
    ...
    public function setUsrUpdateDate($v)
    {
        ...
        if ($this->usr_update_date !== null || $dt !== null) {
            if ($dt !== $this->usr_update_date) {
                ...
                $this->modifiedColumns[] = UserTableMap::USR_UPDATE_DATE;
            }
        } // if either are not null
    ...
    public function setUsrStatus($v)
    {
        ...
        if ($this->usr_status !== $v) {
            $this->usr_status = $v;
            $this->modifiedColumns[] = UserTableMap::USR_STATUS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UserTableMap::translateFieldName('UsrFirstName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_first_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UserTableMap::translateFieldName('UsrLastName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_last_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UserTableMap::translateFieldName('UsrCreateDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->usr_create_date = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UserTableMap::translateFieldName('UsrUpdateDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->usr_update_date = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UserTableMap::translateFieldName('UsrStatus', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException("Error populating \Sandbox\Model\User object", 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::USR_ID)) {
            $modifiedColumns[':p' . $index++]  = 'USR_ID';
        }
        if ($this->isColumnModified(UserTableMap::USR_FIRST_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'USR_FIRST_NAME';
        }
        if ($this->isColumnModified(UserTableMap::USR_LAST_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'USR_LAST_NAME';
        }
        if ($this->isColumnModified(UserTableMap::USR_CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'USR_CREATE_DATE';
        }
        if ($this->isColumnModified(UserTableMap::USR_UPDATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'USR_UPDATE_DATE';
        }
        if ($this->isColumnModified(UserTableMap::USR_STATUS)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getUsrCreateDate(),
            $keys[4] => $this->getUsrUpdateDate(),
            $keys[5] => $this->getUsrStatus(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setUsrCreateDate($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setUsrUpdateDate($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setUsrStatus($arr[$keys[5]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::USR_ID)) $criteria->add(UserTableMap::USR_ID, $this->usr_id);
        if ($this->isColumnModified(UserTableMap::USR_FIRST_NAME)) $criteria->add(UserTableMap::USR_FIRST_NAME, $this->usr_first_name);
        if ($this->isColumnModified(UserTableMap::USR_LAST_NAME)) $criteria->add(UserTableMap::USR_LAST_NAME, $this->usr_last_name);
        if ($this->isColumnModified(UserTableMap::USR_CREATE_DATE)) $criteria->add(UserTableMap::USR_CREATE_DATE, $this->usr_create_date);
        if ($this->isColumnModified(UserTableMap::USR_UPDATE_DATE)) $criteria->add(UserTableMap::USR_UPDATE_DATE, $this->usr_update_date);
        if ($this->isColumnModified(UserTableMap::USR_STATUS)) $criteria->add(UserTableMap::USR_STATUS, $this->usr_status);
    ...
    {
        $criteria = new Criteria(UserTableMap::DATABASE_NAME);
        $criteria->add(UserTableMap::USR_ID, $this->usr_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Sandbox\Model\User (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Sandbox\Model\User Clone of current object.
     * @throws PropelException
     */
     ...
     * @return Collection|ChildUserRol[] List of ChildUserRol objects
     */
    public function getUserRolsJoinRol($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildUserRolQuery::create(null, $criteria);
