...
use Sandbox\Model\Publisher;
use Sandbox\Model\PublisherQuery;
...
class PublisherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Sandbox.Model.Map.PublisherTableMap';
     ...
     */
    const OM_CLASS = '\\Sandbox\\Model\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Sandbox.Model.Publisher';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(PublisherTableMap::ID, PublisherTableMap::NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(PublisherTableMap::ID => 0, PublisherTableMap::NAME => 1, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Sandbox\\Model\\Publisher');
    ...
    {
        $this->addRelation('Book', '\\Sandbox\\Model\\Book', RelationMap::ONE_TO_MANY, array('id' => 'publisher_id', ), null, null, 'Books');
    } // buildRelations()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PublisherTableMap::ID);
            $criteria->addSelectColumn(PublisherTableMap::NAME);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Sandbox\Model\Publisher) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(PublisherTableMap::DATABASE_NAME);
            $criteria->add(PublisherTableMap::ID, (array) $values, Criteria::IN);
        }

        $query = PublisherQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) { PublisherTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) { PublisherTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(PublisherTableMap::ID) && $criteria->keyContainsValue(PublisherTableMap::ID) ) {
