...
use Sandbox\Model\Book;
use Sandbox\Model\BookQuery;
...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Sandbox.Model.Map.BookTableMap';
     ...
     */
    const OM_CLASS = '\\Sandbox\\Model\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Sandbox.Model.Book';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_STUDLYPHPNAME => array('id', 'title', 'iSBN', 'publisherId', 'authorId', ),
        self::TYPE_COLNAME       => array(BookTableMap::ID, BookTableMap::TITLE, BookTableMap::ISBN, BookTableMap::PUBLISHER_ID, BookTableMap::AUTHOR_ID, ),
        self::TYPE_RAW_COLNAME   => array('ID', 'TITLE', 'ISBN', 'PUBLISHER_ID', 'AUTHOR_ID', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'title' => 1, 'iSBN' => 2, 'publisherId' => 3, 'authorId' => 4, ),
        self::TYPE_COLNAME       => array(BookTableMap::ID => 0, BookTableMap::TITLE => 1, BookTableMap::ISBN => 2, BookTableMap::PUBLISHER_ID => 3, BookTableMap::AUTHOR_ID => 4, ),
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'TITLE' => 1, 'ISBN' => 2, 'PUBLISHER_ID' => 3, 'AUTHOR_ID' => 4, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Sandbox\\Model\\Book');
    ...
    {
        $this->addRelation('Publisher', '\\Sandbox\\Model\\Publisher', RelationMap::MANY_TO_ONE, array('publisher_id' => 'id', ), null, null);
        $this->addRelation('Author', '\\Sandbox\\Model\\Author', RelationMap::MANY_TO_ONE, array('author_id' => 'id', ), null, null);
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Sandbox\Model\Book) { // it's a model object
