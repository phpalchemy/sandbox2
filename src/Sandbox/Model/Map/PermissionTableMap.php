...
use Sandbox\Model\Permission;
use Sandbox\Model\PermissionQuery;
...
class PermissionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Sandbox.Model.Map.PermissionTableMap';
     ...
     */
    const OM_CLASS = '\\Sandbox\\Model\\Permission';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Sandbox.Model.Permission';
     ...
     */
    const PRM_ID = 'permission.PRM_ID';

    /**
     * the column name for the PRM_NAME field
     */
    const PRM_NAME = 'permission.PRM_NAME';

    /**
     * the column name for the PRM_CREATE_DATE field
     */
    const PRM_CREATE_DATE = 'permission.PRM_CREATE_DATE';

    /**
     * the column name for the PRM_UPDATE_DATE field
     */
    const PRM_UPDATE_DATE = 'permission.PRM_UPDATE_DATE';

    /**
     * the column name for the PRM_STATUS field
     */
    const PRM_STATUS = 'permission.PRM_STATUS';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(PermissionTableMap::PRM_ID, PermissionTableMap::PRM_NAME, PermissionTableMap::PRM_CREATE_DATE, PermissionTableMap::PRM_UPDATE_DATE, PermissionTableMap::PRM_STATUS, ),
        self::TYPE_RAW_COLNAME   => array('PRM_ID', 'PRM_NAME', 'PRM_CREATE_DATE', 'PRM_UPDATE_DATE', 'PRM_STATUS', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(PermissionTableMap::PRM_ID => 0, PermissionTableMap::PRM_NAME => 1, PermissionTableMap::PRM_CREATE_DATE => 2, PermissionTableMap::PRM_UPDATE_DATE => 3, PermissionTableMap::PRM_STATUS => 4, ),
        self::TYPE_RAW_COLNAME   => array('PRM_ID' => 0, 'PRM_NAME' => 1, 'PRM_CREATE_DATE' => 2, 'PRM_UPDATE_DATE' => 3, 'PRM_STATUS' => 4, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Sandbox\\Model\\Permission');
    ...
    {
        $this->addRelation('RolPermission', '\\Sandbox\\Model\\RolPermission', RelationMap::ONE_TO_MANY, array('prm_id' => 'prm_id', ), 'CASCADE', null, 'RolPermissions');
    } // buildRelations()
    /**
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PermissionTableMap::PRM_ID);
            $criteria->addSelectColumn(PermissionTableMap::PRM_NAME);
            $criteria->addSelectColumn(PermissionTableMap::PRM_CREATE_DATE);
            $criteria->addSelectColumn(PermissionTableMap::PRM_UPDATE_DATE);
            $criteria->addSelectColumn(PermissionTableMap::PRM_STATUS);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Sandbox\Model\Permission) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(PermissionTableMap::DATABASE_NAME);
            $criteria->add(PermissionTableMap::PRM_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(PermissionTableMap::PRM_ID) && $criteria->keyContainsValue(PermissionTableMap::PRM_ID) ) {
