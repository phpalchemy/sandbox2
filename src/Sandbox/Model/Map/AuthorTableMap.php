...
use Sandbox\Model\Author;
use Sandbox\Model\AuthorQuery;
...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Sandbox.Model.Map.AuthorTableMap';
     ...
     */
    const OM_CLASS = '\\Sandbox\\Model\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Sandbox.Model.Author';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Sandbox\\Model\\Author');
    ...
    {
        $this->addRelation('Book', '\\Sandbox\\Model\\Book', RelationMap::ONE_TO_MANY, array('id' => 'author_id', ), null, null, 'Books');
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Sandbox\Model\Author) { // it's a model object
